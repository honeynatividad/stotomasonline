...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Update Vision</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminpagecontent.php">Page Content</a></li>
            <li class="breadcrumb-item">Update Vision</li>
    ...
    $vctr=0;
        $result = mysql_query("SELECT * FROM tblaboutus WHERE aboutus='Vision' ");
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                if($count!=0) {
                    $sql="UPDATE tblaboutus SET aboutusDesc='$desc' WHERE aboutus='Vision'";
                } else {
                    $sql="INSERT INTO tblaboutus (aboutus, aboutusDesc) VALUES ('Vision', '$desc')";
                }
    ...
    ?>
            ...
            <form action="adminpagecontentaboutusvision.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Vision</label>
                  <div class="col-sm-3">
                  <textarea class="form-control col-sm-6" id="validationCustom01" name="aboutusDesc" required><?php echo $aboutusDesc; ?>
                    </textarea>
                    </div>
