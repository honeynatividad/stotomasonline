...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <?php
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                mysql_query("UPDATE tblfeedback SET fldtitle = '$vtitlex',fldfeedback = '$vfeedbackx',fldstatus = '$vstatusx' WHERE fldcode = '$vcodex'");		
                
                 ?>
                    <script>
				    alert("Feedback Udated.");	
				    </script>   
    ...
    ?>
            ...
            <form action="farmfeedbackedit.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  ...
                  <textarea id="validationCustom01" rows="4" class="form-control col-sm-2" name="txtfeedback"><?php echo $vfeedbackx; ?></textarea>
