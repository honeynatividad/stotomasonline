...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-files"></i>&nbsp;Dashboard / Reports / Seed Request</h5> 
      
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
            <li class="breadcrumb-item">Reports</li>
          <li class="breadcrumb-item">Seed Request</li>
        </ol>
      </nav>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <form name="formadd1" enctype="multipart/form-data" target="_blank" action="tcpdf/examples/storeprequest.php" method="post" class="form-horizontal" id="block-validate">	
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="inputState" class="form-label col-sm-2 col-form-label">Barangays</label>
                 <div class="col-sm-3">
                  <select id="inputState" class="form-select" name="txtbarangay">
                    <option value="All">All</option>
                      <?php
                ...
                <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">Starting Date</label>
                  <div class="col-sm-3">
                    <input type="date" class="form-control" name="txtstartingdate">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">Ending Date</label>
                  <div class="col-sm-3">
                    <input type="date" class="form-control" name="txtendingdate">
                  </div>
                </div>
