...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <?php
        ...
        $result = mysql_query("SELECT * FROM tblfarm where fldcode='$vcodex'");
        while($row = mysql_fetch_array($result))
        {
    ...
    ?>
            ...
            <form action="adminfarmersfarmedit.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
