...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Delete Image for Farm Inputs Distribution</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminpagecontent.php">Page Content</a></li>
            <li class="breadcrumb-item"><a href="adminpagecontenthomefarminputs.php">Manage Images for Farm Inputs Distribution</a></li>
                <li class="breadcrumb-item">Delete Image for Farm Inputs Distribution</li>
        </ol>
      </nav>
   ...
   $vcodex=$_REQUEST['vuid'];
        ...
        $result = mysql_query("SELECT * FROM tblpagefarminputs where fldcode='$vcodex'");
        while($row = mysql_fetch_array($result))
        {
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                mysql_query("DELETE FROM tblpagefarminputs WHERE fldcode = '$vcodex'");
                
				    ?>
                    <script>
				    alert("Farm Inputs Distribution Image Deleted.");	
				    </script>   
    		          <meta  http-equiv="refresh" content=".000001;url=adminpagecontenthomefarminputs.php" />
            	       <?php   
    ...
    ?>
            ...
            <br>
            <form action="adminpagecontenthomefarminputsedit.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Carousell Image</label>
                  <div class="col-sm-3">
                  <img src="img/<?php echo $vimagex; ?>" width="130" height="130">
                    </div>
                  
                </div>
                
                <div class="col-12">
                  <button class="btn btn-danger" type="submit" onClick="fSave1()">Delete</button>
                  <button class="btn btn-warning" type="button" onclick="window.location.href='adminpagecontenthomefarminputs.php'">Return</button>
                </div>
