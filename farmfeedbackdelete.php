...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-chat-text"></i>&nbsp;Feedback / Delete</h5>
    ...
    <?php
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                mysql_query("UPDATE tblfeedback SET fldstatus = 'Deleted' WHERE fldcode = '$vcodex'");		
    ...
    ?>
            ...
            <form action="farmfeedbackdelete.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
