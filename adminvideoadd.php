...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Add New Video</h5>
    ...
    $vctr=0;
        $result = mysql_query("SELECT * FROM tblvideo order by fldindex");
        while($row = mysql_fetch_array($result))
        {
            $vctr=$row['fldindex'];
        }
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $sql="INSERT INTO tblvideo (fldindex, fldcode, fldcrops, fldvideo, fldimage, fldstatus) 
	VALUES ('$vctr','$vcodex','$vcropsx','$vvideox','$pic','$vstatusx')";
    ...
    ?>
            ...
            <form action="adminvideoadd.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                  <input type="text" class="form-control" id="validationCustom02" name="txtvideo" value="<?php echo $videox; ?>" required>
                    </div>
