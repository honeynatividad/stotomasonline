...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-people"></i>&nbsp;Users / Farmers / Farm / Add Farm</h5>
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Users</a></li>
            ...
            <li class="breadcrumb-item"><a href="">Add Farm </a></li>
    ...
    $vctr=0;
        $result = mysql_query("SELECT * FROM tblfarm order by fldindex");
        while($row = mysql_fetch_array($result))
        {
            $vctr=$row['fldindex'];
        }
    ...
    ?>
            ...
            <form action="adminfarmersfarmadd.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
