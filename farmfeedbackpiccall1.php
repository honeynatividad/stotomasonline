...
<head>
   ...
   <body >
    ...
    function myFunction0() {
     ...
     window.open("farmfeedbackpicdelete.php?vuid=<?php echo $vcodex; ?>&vuid1=<?php echo $vfeedbackcodex; ?>", "_blank", "toolbar=no,scrollbars=yes,resizable=no,top=100,left=300,width=700,height=550");
    }
    </script>  
