...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link " href="admininsurance.php">
...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-journal-bookmark"></i>&nbsp;Insurance / Edit Insurance Form</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admininsurance.php">Insurance</a></li>
            <li class="breadcrumb-item">Add New Insurance Form</li>
    ...
    $vcodex=$_REQUEST['vuid'];
        ...
        $result = mysql_query("SELECT * FROM tblinsurance where fldcode='$vcodex'");
        while($row = mysql_fetch_array($result))
        {
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $vinsurancex=$_POST['txtinsurance'];
				...
				if($pic=="")
				{
				    $pic=$vinsurancex;
				     ...
				     mysql_query("UPDATE tblinsurance SET fldinsurance = '$pic',fldstatus = '$vstatusx' WHERE fldcode = '$vcodex'");		
    ...
    ?>
            ...
            <form action="admininsuranceedit.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             ...
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  ...
                  <div  data-provides="fileupload" class="col-sm-3">
                    <input type="text" class="form-control col-sm-6" id="validationCustom01" readonly name="txtinsurance" value="<?php echo $vinsurancex; ?>" required><br>
