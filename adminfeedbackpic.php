      ...
      <div class="row">
                            		          ...
                            		          <tr>
                                                ...
                                                ?>
                                                    ...
                                                    <td align=center>
                                                        ...
                                                        <a href="adminfeedbackpiccall.php?vuid=<?php echo $arrcode[$vi1]; ?>&vuid1=<?php echo $vfeedbackcodex; ?>"><img width="305" height="150" src="assets/img/<?php echo $arrpicture[$vi1]; ?>"></a>
                                                        <div>
        ...
        ///////////////////////////////////email
              ...
              <!-- End Table with stripped rows -->
                ...
                <button class="btn btn-warning btn-sm" type="button" onclick="window.location.href='adminfeedback.php'">Return</button>
