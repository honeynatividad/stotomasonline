    ...
    <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Manage Page Content</h5>
              ...
              <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                  ...
                  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <a href="adminpagecontenthomecarousell.php">Manage Images for Carousell</a><hr/>
                        <a href="adminpagecontenthomefarminputs.php">Manage Images for Farm Inputs Distribution</a><hr/>
                        <a href="adminpagecontenthomegulayan.php">Manage Images for Gulayan sa Tahanan at Paaralan</a><hr/>
                        <a href="adminpagecontenthometrainings.php">Manage Images for Trainings and Seminars</a>
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <a href="adminpagecontentannouncement.php">Manage Images for Announcements</a><hr/>
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <a href="adminpagecontentcrops.php">Manage Images and Videos for Crops</a><hr/>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="heading5" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        ...
                        <a href="adminpagecontentannouncement.php">Manage Images and Text for Frequently Asked Questions (FAQs)</a><hr/>
                    </div>
                  </div>
                </div>
