...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link " href="adminbarangays.php">
...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-shop"></i>&nbsp;Barangays / Add New Barangay</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminbarangays.php">Barangays</a></li>
            <li class="breadcrumb-item">Add New Barangay</li>
    ...
    $vctr=0;
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
				...
				$result = mysql_query("SELECT * FROM tblbarangay where fldbarangay='$vbarangayx' order by fldindex");
				while($row = mysql_fetch_array($result))
				{
				    $vdup=1;
				}		
				...
				?>
                    <script>
				    alert("Duplicate Barangay.");				
				    </script>   
    	       <?php	
				}
				else
				{
				    $sql="INSERT INTO tblbarangay (fldindex, fldbarangay, fldlong, fldlat) VALUES ('$vctr','$vbarangayx','$fldlong','$fldlat')";
				    ...
				    ?>
                    <script>
				    alert("New Barangay Saved.");	
				    </script>   
    		          <meta  http-equiv="refresh" content=".000001;url=adminbarangays.php" />
            	       <?php   
				}
            }
        }
    ...
    ?>
            ...
            <form action="adminbarangaysadd.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="validationCustom02" class="form-label col-sm-2 col-form-label">Barangay</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="validationCustom02" name="txtbarangay" value="<?php echo $vbarangayx; ?>" required>
                    </div>
                ...
                <div class="col-12">
                  ...
                  <button class="btn btn-warning" type="button" onclick="window.location.href='adminbarangays.php'">Return</button>
                </div>
