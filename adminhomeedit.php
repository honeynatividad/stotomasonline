  ...
  <!-- ======= Header ======= -->
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="adminadmin.php">
            ...
            <li class="nav-item">
                <a class="nav-link " href="adminpagecontent.php">
...
<!-- End Menu -->
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Add New Announcement</h5>
        
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="adminpagecontent.php">Page Content</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            $result = mysql_query("SELECT * FROM tblhomepage where fldindex='$vcodex'");
                            while($row = mysql_fetch_array($result)) {
                                $fldhometitle=$row['fldhometitle'];
                                $fldhomesubtitle=$row['fldhomesubtitle'];
                            ...
                            if($vtest==0) {
                                if($vtestx==1){
                                    ...
                                    $fldhometitle=$_POST['homepagetitle'];
                                    $fldhomesubtitle=$_POST['homepagesubtitle'];
                                    ...
                                    mysql_query("UPDATE tblhomepage SET fldbanner = '$newfilename',fldhometitle = '$fldhometitle', fldhomesubtitle='$fldhomesubtitle', fldstatus='$txtstatus' WHERE fldcode = '$vcodex'");		
                                    ...
                                    if(move_uploaded_file($_FILES['photo']['tmp_name'], $target)){
                                        ...
                                        <meta  http-equiv="refresh" content=".000001;url=adminpagecontenthome.php" />
                                        <?php   
    ...
    /////////////////////////////////////////////////////////
             ...
             <!-- Custom Styled Validation -->
                            ...
                            <form action="adminhomeedit.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                                ...
                                <div class="row mb-3">
                                    <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Banner</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    <label for="inputState" class="form-label col-sm-2 col-form-label">Home Page Title</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control col-sm-6" id="validationCustom01" value="<?php echo $fldhometitle ?>" name="homepagetitle" />
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label for="inputState" class="form-label col-sm-2 col-form-label">Home Page Sub Title</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control col-sm-6" id="validationCustom01" value="<?php echo $fldhomesubtitle ?>" name="homepagesubtitle" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <button class="btn btn-warning" type="button" onclick="window.location.href='adminpagecontent.php'">Return</button>
                                </div>
