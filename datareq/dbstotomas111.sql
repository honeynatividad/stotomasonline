...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 04, 2023 at 05:48 AM
...
CREATE TABLE `tblAboutUs` (
  ...
  `aboutusDesc` longtext DEFAULT NULL
...
CREATE TABLE `tblchatbotresponse` (
  `fldindex` bigint(20) NOT NULL,
  `fldresponse` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `tblinsuranceaccomplish` (
  `fldindex` bigint(20) NOT NULL,
  `fldcode` varchar(200) NOT NULL,
...
CREATE TABLE `tblpagefarminputs` (
  `fldindex` bigint(20) NOT NULL,
  `fldcode` varchar(200) NOT NULL,
  `fldimage` varchar(200) NOT NULL,
  `fldstatus` varchar(200) NOT NULL
...
CREATE TABLE `tblseeddistribution` (
  `fldindex` bigint(20) NOT NULL,
  `fldcode` varchar(200) NOT NULL,
...
(9, 'USER2', 'CROP1', 'Ampalaya', 600),
(10, 'USER2', 'CROP2', 'Eggplant', 400),
(11, 'USER2', 'CROP4', 'Cucumber', 1200),
(12, 'USER2', 'CROP5', 'Okra', 1501),
(13, 'USER2', 'CROP6', 'Pole Sitao', 900),
(14, 'USER2', 'CROP7', 'Tomato', 810),
(15, 'USER2', 'CROP8', 'Patola', 0),
(16, 'USER2', 'CROP9', 'Squash', 700),
...
(1, 'USER1', 'contactus@stotomaswebsite.online', '123', 'Alden', 'Pelayo', '', 0, '', 'Admin', 'man4.jpg', '12345', 'Active', 'alden.richards'),
