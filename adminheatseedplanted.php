...
function initMap() {
    $.post("newmapfarmerdataseedplanted.php",
    function (data){
        ...
        for(let i = 0; i < mapData.length; i++) {
            ...
            let marker = new google.maps.Marker({
                position: mapAddress,
                icon: "https://stotomaswebsite.online/img/seed-planted.png",
                map,
...
<body>
  ...
  <!-- End Sidebar-->
    ...
    <div align=right>
        <button class="btn btn-warning" type="button" onclick="window.location.href='adminheatmapcrops.php'">Crops</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
  <!-- ======= Footer ======= -->
