...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Update Mission</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminpagecontent.php">Page Content</a></li>
            <li class="breadcrumb-item">Update Mission</li>
    ...
    $vctr=0;
        $result = mysql_query("SELECT * FROM tblaboutus WHERE aboutus='Mission' ");
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $desc=$_POST['aboutusDesc'];
                if($count!=0) {
                    $sql="UPDATE tblaboutus SET aboutusDesc='$desc' WHERE aboutus='Mission'";
                } else {
                    $sql="INSERT INTO tblaboutus (aboutus, aboutusDesc) VALUES ('Mission', '$desc')";
                }
    ...
    ?>
            ...
            <form action="adminpagecontentaboutusmission.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Mission</label>
                  <div class="col-sm-3">
                  <textarea class="form-control col-sm-6" id="validationCustom01" name="aboutusDesc" value="<?php echo $aboutusDesc; ?>" required>
                    </textarea>
                    </div>
