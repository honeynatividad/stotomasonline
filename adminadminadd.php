...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-people"></i>&nbsp;Users / System Administrators / Add</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Users</a></li>
            <li class="breadcrumb-item">System Administrators</li>
    ...
    $vctr=0;
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $vusertypex="System Administrator";
    	       ...
    	       <?php	
				...
				else
				{
				    ...
				    ?>
                    <script>
				    alert("New System Administrator Saved.");	
				    </script>   
    ...
    ?>
            ...
            <form action="adminadminadd.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="validationCustom02" class="form-label col-sm-2 col-form-label">Last name</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" pattern="[a-zA-Z]*" id="validationCustom02" name="txtlastname"  value="<?php echo $vlastnamef; ?>" required>
                    </div>
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control col-sm-6" id="validationCustom01" name="txtusername" value="<?php echo $vusernamef; ?>" required>
                    </div>
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                ...
                <div class="col-12">
                  ...
                  <button class="btn btn-warning" type="button" onclick="window.location.href='adminadmin.php'">Return</button>
                </div>
