...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-files"></i>&nbsp;Reports / For Intervention</h5> 
      
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminreports.php">Reports</a></li>
          <li class="breadcrumb-item">For Intervention</li>
        </ol>
      </nav>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <form name="formadd1" enctype="multipart/form-data" target="_blank" action="tcpdf/examples/storepbarangay.php" method="post" class="form-horizontal" id="block-validate">	
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="col-12">
                  ...
                  <button class="btn btn-warning" type="button" onclick="window.location.href='adminreports.php'">Return</button>
                </div>
