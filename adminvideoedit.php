...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Edit Video</h5>
    ...
    ////////////////////////////////////////////////save data
        ...
        $result = mysql_query("SELECT * FROM tblvideo where fldcode='$vcodex'");
        while($row = mysql_fetch_array($result))
        {
            $vvideox=$row['fldvideo'];
    ...
    $vctr=0;
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                mysql_query("UPDATE tblvideo SET fldvideo = '$vvideox',fldcrops = '$vcropsx',fldimage = '$pic',fldstatus = '$vstatusx' WHERE fldcode = '$vcodex'");		
    ...
    ?>
            ...
            <form action="adminvideoedit.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="validationCustom02" class="form-label col-sm-2 col-form-label">Crops</label>
                    <div class="col-sm-6">
                ...
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Video Link</label>
                  <div class="col-sm-6">
                  <input type="text" class="form-control" id="validationCustom02" name="txtvideo" value="<?php echo $vvideox; ?>" required>
                    </div>
                
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Video Image</label>
                  <div class="col-sm-3">
                      <br>
                <input type="text" class="form-control col-sm-6" id="validationCustom01" readonly name="txtimage" value="<?php echo $vimagex; ?>" required><br>
