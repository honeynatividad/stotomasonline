...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-files"></i>&nbsp;Reports / Summary Seed Distribution</h5> 
      
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminreports.php">Reports</a></li>
          <li class="breadcrumb-item"><a href="adminreportsdistributionsum.php">Summary Seed Distribution</li>
        </ol>
      </nav>
...
?>
        ...
        while($row = mysql_fetch_array($result))
        {
            ...
            if($vbarangay=="San Joaquin")
            {
                ...
                else
                {
                    ...
                    while($row1 = mysql_fetch_array($result1))
                    {
                        if($vcropcategoryx==$vseeddistributed)
                        {
    ...
    <script src="https://cdn.canvasjs.com/canvasjs.min.js"></script>        
              ...
              <!-- End Table with stripped rows -->
                ...
                <hr/>
                                        <button type="reset" class="btn btn-warning"  onclick="window.location.href='adminreportsdistributionsum.php'">Return</button>
            </div>
