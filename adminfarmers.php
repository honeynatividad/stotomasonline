...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-people"></i>&nbsp;Users / Farmers</h5>
      <!--
      <nav>
        <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminfarmersadd.php'">Add New Farmer</button>
            <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminimportfarmers.php'">Import Farmers' Record</button>
               <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminadmin.php'">System Administrator</button>
            <hr/>
