...
<script>
        	...
        	<?php 
								...
								$result = mysql_query("SELECT * FROM tbluser where fldemail='$vemail2'");
								while($row = mysql_fetch_array($result))
								{
									$vtest2=1;
                                    $vpassword=$row['fldpassword'];
                                    $vfarmername=$row['fldfirstname']." ".$row['fldmiddlename']." ".$row['fldlastname'];
								}
								if($vtest2==0)
								{
									$vtestxxx=0;
								...
								if($vtest2==1)
								{
                                   // echo "aaa".$vemail2; 
                                    ...
                                    ////////////////////////////////////email
                                        ...
                                        $message = 'Dear '.$vfarmername."\r\n"."\r\n".' , Your password is '.$vpassword.'.'."\r\n"."\r\n".'Thank you.';
                                        $headers = 'From: '.'admin@stotomas.gov.ph'. "\r\n" .
                                        'Reply-To:'.'admin@stotomas.gov.ph'. "\r\n" .
            ...
            <?php
								...
								?>
    <main>
  <form action="recover.php" name="frm" class="" id="block-validate" method="post">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" class="form-control" id="inputEmail" name="email2" value="" required>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" onClick="fSave()" type="submit">Submit</button>
                    </div>
