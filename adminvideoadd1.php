    ...
    $vctr=0;
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $sql="INSERT INTO tblvideo (fldindex, fldcode, fldcrops, fldvideo, fldstatus) 
	VALUES ('$vctr','$vcodex','$vcropsx','$pic','$vstatusx')";
    ...
    ?>
            ...
            <form action="adminvideoadd.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Video</label>
                  <div class="col-sm-3">
                ...
                <div class="row mb-3">
                 ...
                 <div class="col-sm-3">
                  <select id="inputState" class="form-select" name="txtstatus">
                    ...
                    <option value="Not Available">Published</option>
                    <option value="Available">Not Published</option>
