function formInit() {
	...
	//////////////akin
	 ...
	 $('#dtpopportunitycreated').datepicker();
	 $('#dtpprogramdatefrom').datepicker();
	 $('#dtpprogramdateto').datepicker();
	 $('#dtpforecastclosedate').datepicker();
	 $('#dtppaymentdate').datepicker();
	 $('#dtpdeliverydate').datepicker();
	 
	 $('#dtpsdate').datepicker();
	 $('#dtpedate').datepicker();
  	 $('#dtpsdate1').datepicker();
	 $('#dtpedate1').datepicker();
	 $('#dtppurchaserequestdate').datepicker();
	 ///////////////////////////////////////////////////////////
	 $('#dtpdateincorporated').datepicker();
     $('#dtpdateentered').datepicker();
	 $('#dtpdateresigned').datepicker();
	 $('#dtpdateoftransfer').datepicker();
	 
	 $('#dtpdateacquisition').datepicker();
	 $('#dtpdate').datepicker();
	 $('#dtpdatepurchase').datepicker();
