...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Add New Image for Carousell</h5>
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminpagecontent.php">Page Content</a></li>
            <li class="breadcrumb-item"><a href="adminpagecontenthomecarousell.php">Manage Images for Carousell</a></li>
                <li class="breadcrumb-item">Add New Image for Carousell</li>
    ...
    $vctr=0;
        $result = mysql_query("SELECT * FROM tblpagecarousell order by fldindex");
        while($row = mysql_fetch_array($result))
        {
            $vctr=$row['fldindex'];
        }
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $sql="INSERT INTO tblpagecarousell (fldindex, fldcode, fldimage, fldstatus) 
	VALUES ('$vctr','$vcodex','$pic','Published')";
				    ...
				    ?>
                    <script>
				    alert("New Carousell Image Saved.");	
				    </script>   
    ...
    ?>
            ...
            <br>
            <form action="adminpagecontenthomecarouselladd.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
