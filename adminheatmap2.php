    ...
    function (data){
        ...
        for(let i = 0; i < mapData.length; i++) {
            ...
            let contentString =
                ...
                '<div id="siteNotice">' +
                "</div>" +
                '<h1 id="firstHeading" class="firstHeading">'+ obj.farmname +'</h1>' +
                '<div id="bodyContent">' +
                "<p><b>Seed Requested:</b><br>" + fieldcrops +
            ...
            let marker = new google.maps.Marker({
                position: mapAddress,
                icon: "https://maps.google.com/mapfiles/kml/shapes/parks.png",
                map,
...
<body>
  ...
  <!-- End Sidebar-->
    ...
    <div align=right>
        <button class="btn btn-warning" type="button" onclick="window.location.href='adminheatmapyield.php'">Seed Request</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
    <div align=right>
        <button class="btn btn-warning" type="button" onclick="window.location.href='adminheatmapyield.php'">Seed Distribution</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
    <div align=right>
        <button class="btn btn-warning" type="button" onclick="window.location.href='adminheatmapyield.php'">Seed Planted</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
    <div align=right>
        <button class="btn btn-warning" type="button" onclick="window.location.href='adminheatmapyield.php'">Crops</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
  <!-- ======= Footer ======= -->
