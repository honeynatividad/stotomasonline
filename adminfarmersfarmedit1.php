...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-people"></i>&nbsp;Users / Farmers / Farm / Edit </h5>
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Users</a></li>
            ...
            <li class="breadcrumb-item"><a href="adminfarmersfarm.php?vuid=<?php echo $vcodex; ?>">Farm </a></li>
    ...
    <?php
        ...
        $vfarmercodex=$_REQUEST['vuid'];
        $vcodex=$_REQUEST['vuid1'];
								
        $result = mysql_query("SELECT * FROM tbluser where fldcode='$vfarmercodex'");
        while($row = mysql_fetch_array($result))
        {
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $vlotareax=$_POST['txtlotarea'];
				    ...
				    mysql_query("UPDATE tbluser SET fldlocation = '$vlocationx',fldlotarea = '$vlotareax' WHERE fldcode = '$vcodex'");		
    ...
    ?>
            ...
            <form action="adminfarmersfarmedit1.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                    ...
                    <input type="hidden" name="txtcode" id="txtcode" value="<?php echo $vfarmercodex; ?>">
                  <div>
                  </div>
                <div>
                ...
                <div class="col-12">
                  ...
                  <button class="btn btn-warning" type="button" onclick="window.location.href='adminfarmersfarm.php?vuid=<?php echo $vfarmerscodex; ?>'">Return</button>
                </div>
