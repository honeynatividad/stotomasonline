...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-people"></i>&nbsp;Users / Farmers / Add</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminfarmers.php">Users</a></li>
    ...
    $vctr=0;
        ...
        if($vtest==0)
        {
          ...
          $password = password_hash('12345', PASSWORD_DEFAULT);
                    ...
                    VALUES ('$vctr','$vcodex','$vlastnamex','$vfirstnamex','$vmiddlenamex','$vusertypex','$vemailx','user.png','$password','$vusernamex','$vstatusx',  '$vgenderx')";
    ...
    ?>
            ...
            <form action="adminfarmersadd.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
