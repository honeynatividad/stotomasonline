...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-chat-text"></i>&nbsp;Feedback / View Feedback</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminfeedback.php">Feedback</a></li>
    ...
    <?php
    $vfemail=$_REQUEST['vuid1'];
    $vcodex=$_REQUEST['vuid'];
								
        $result = mysql_query("SELECT * FROM tblfeedback where fldcode='$vcodex'");
        while($row = mysql_fetch_array($result))
        {
        ...
        ///////email
                                        $to      = $vfemail;
                                        $subject = 'Feedback Viewed';
                                        $message = 'Dear '.$vfirstnamex."\r\n"."\r\n".'Your Feedback has been viewed.'."\r\n"."\r\n".'Thank you.';
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                mysql_query("UPDATE tblfeedback SET fldstatus = 'ADeleted' WHERE fldcode = '$vcodex'");		
										
				    ?>
                    <script>
				    alert("Feedback Deleted.");	
				    </script>   
    		          <meta  http-equiv="refresh" content=".000001;url=adminfeedback.php" />
            	       <?php   
    ...
    ?>
            ...
            <form action="adminfeedbackdelete.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  ...
                  <input type="text" class="form-control readonly col-sm-2" placeholder="" id="validationCustom01" name="txttitle" value="<?php echo $vtitlex; ?>" required>  
                ...
                <div class="row mb-3">
                  ...
                  <textarea id="validationCustom01" readonly rows="4" class="form-control col-sm-2" name="txtfeedback"><?php echo $vfeedbackx; ?></textarea>
                ...
                <div class="col-12">
                  ...
                  <button class="btn btn-warning" type="button" onclick="window.location.href='adminfeedback.php'">Return</button>
                </div>
