...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-slack"></i>&nbsp;Harvesting Crops / Picture</h5> 
      
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="farmharvestcrops.php">Harvesting Crops</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <br>
                <font color=blue>Pictures - <?php echo $vcropsx; ?></font>
            ...
            <table class="table">
              ...
              <?php
                                    ...
                                    $vi=0;
                                    $result = mysql_query("SELECT * FROM tblpicharvest where fldseedplantedcode='$vseedplantedcodex'");
		                              while($row = mysql_fetch_array($result))
		                              {
                            		          ...
                            		          <tr>
                                                ...
                                                ?>
                                                    ...
                                                    <td align=center>
                                                        ...
                                                        <a href="farmharvestcropspiccall.php?vuid=<?php echo $arrcode[$vi1]; ?>&vuid1=<?php echo $vseedplantedcodex ?>&vuid2=<?php echo $vcropsx; ?>"><img width="305" height="150" src="assets/img/<?php echo $arrpicture[$vi1]; ?>"></a>
                                                        <div>
                                                        <?php echo $arrdescription[$vi1]; ?>
                                                        </div>
                                                        <div>
                                                     <button title="Delete Picture" onclick="window.location.href='farmharvestcropspiccall1.php?vuid=<?php echo $arrcode[$vi1]; ?>&vuid1=<?php echo $vseedplantedcodex ?>&vuid2=<?php echo $vcropsx; ?>'" type="button" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></button>  
                                                        </div>    
                                                  </td>
                                                    <!--end section -->
                                                <?php
              ...
              <!-- End Table with stripped rows -->
                ...
                <button class="btn btn-warning btn-sm" type="button" onclick="window.location.href='farmharvestcrops.php'">Return</button>
                
            <script>
                function myFunction2() {
                window.open("farmharvestcropspicadd.php?vuid=<?php echo $vseedplantedcodex; ?>&vuid1=<?php echo $vcropsx; ?>", "_blank", "toolbar=no,scrollbars=yes,resizable=no,top=100,left=300,width=700,height=300");
            }
            </script>
            </div>
          </div>
