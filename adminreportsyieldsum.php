...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-files"></i>&nbsp;Reports / Summary of Crop Yields</h5> 
      
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminreports.php">Reports</a></li>
          <li class="breadcrumb-item">Summary of Crop Yields</li>
        </ol>
      </nav>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <form name="formadd1" enctype="multipart/form-data"   action="adminreportsyieldsum1.php" method="post" class="form-horizontal" id="block-validate">	
