...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-people"></i>&nbsp;Users / Farmers / Import Farmers' Record</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Users</a></li>    
            <li class="breadcrumb-item"><a href="adminfarmers.php">Farmers</a></li>    
            <li class="breadcrumb-item">Import Farmers' Record</li>
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
				...
				if($pic=="")
				{
				    ...
				    $sql="INSERT INTO \tblinsurance (fldindex, fldcode, fldinsurance, fldstatus) VALUES ('$vctr','$vcodex','$pic','$vstatusx')";
    ...
    ?>
            ...
            <form action="adminfunction.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             ...
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Select the File for Import</label>
