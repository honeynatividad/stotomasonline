...
<!-- End Menu -->
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Add New Home Page Content</h5>
     
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="adminpagecontent.php">Page Content</a></li>
                    <li class="breadcrumb-item">Add New Home Page Content</li>
                </ol>
            </nav>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    $vctr=0;
                                    $result = mysql_query("SELECT * FROM tblhomepage order by fldindex");
                                    while($row = mysql_fetch_array($result)) {
                                        $vctr=$row['fldindex'];
                                    }
                                    $vctr=$vctr+1;
                                    ...
                                    if($vtest==0){
                                        if($vtestx==1){
                                            ...
                                            $homepagesubtitle = $_POST['homepagesubtitle'];
                                            ...
                                            $sql="INSERT INTO tblhomepage (fldindex, fldhometitle, fldhomesubtitle,fldbanner,fldstatus) VALUES ('$vctr','$homepagetitle','$homepagesubtitle','$newfilename', '$vstatusx')";
                                            ...
                                            ?>
                                        <script>
                                        alert("New Home Page Content Saved.");	
                                        </script>   
                                ...
                                ?>
                                    ...
                                    <form action="adminhomeadd.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
                                <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control col-sm-6" id="validationCustom01" name="homepagetitle" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control col-sm-6" id="validationCustom01" name="homepagesubtitle" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <button class="btn btn-warning" type="button" onclick="window.location.href='adminpagecontenthome.php'">Return</button>
                                        </div>
