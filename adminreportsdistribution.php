...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-files"></i>&nbsp;Dashboard / Reports / Seed Distribution</h5> 
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <form name="formadd1" enctype="multipart/form-data" target="_blank" action="tcpdf/examples/storepdistribution.php" method="post" class="form-horizontal" id="block-validate">	
