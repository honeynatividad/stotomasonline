...
?>
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-flower1"></i>&nbsp;Crops  / Seed Distribution / Distribute</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admincrops.php">Crops</a></li>
            <li class="breadcrumb-item">Manage</li>
            <li class="breadcrumb-item"><a href="adminseeddistributionall.php?vuid=<?php echo $vcropcode; ?>">Seed Distribution</a></li>
            ...
            if($vtestx==1)
            {
                ...
                /////////////////////////////////////////////////////////////////////////
                    ...
                    //{
                        ...
                        ////////////////////////////////////email
                                        $to      = $vfarmeremail;
                                        $subject = 'Approved Seed Request';
                                        $message = 'Dear '.$vfirstnamex."\r\n"."\r\n".'Your Seed Request has been approved for distribution. Come and visit our office for distribution'."\r\n"."\r\n".'Thank you.';
    ...
    ?>
            ...
            <form action="adminseeddistributionall1.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Qty. Distributed (Grams)</label>
                  <div class="col-sm-3">
