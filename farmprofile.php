  ...
  <main id="main" class="main">
    ...
    <?php
        ...
        if($vtest==0)
        {
				...
				if($pic=="")
				{
                  ...
                  $password = password_hash($vpasswordx, PASSWORD_DEFAULT);
								...
								alert("User Profile Updated.");	
    		                     ...
    		                     <meta  http-equiv="refresh" content=".000001;url=farmprofile.php" />
            	               <?php   
								}
				            }
				        }
            ...
            <form action="farmprofile.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
