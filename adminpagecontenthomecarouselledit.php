...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Delete Image for Carousell</h5>
     
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminpagecontent.php">Page Content</a></li>
            <li class="breadcrumb-item"><a href="adminpagecontenthomecarousell.php">Manage Images for Carousell</a></li>
                <li class="breadcrumb-item">Edit Image for Carousell</li>
   ...
   $vcodex=$_REQUEST['vuid'];
        ...
        $result = mysql_query("SELECT * FROM tblpagecarousell where fldcode='$vcodex'");
        while($row = mysql_fetch_array($result))
        {
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                mysql_query("DELETE FROM tblpagecarousell WHERE fldcode = '$vcodex'");
                
				    ?>
                    <script>
				    alert("Carousell Image Deleted.");	
				    </script>   
    		          <meta  http-equiv="refresh" content=".000001;url=adminpagecontenthomecarousell.php" />
            	       <?php   
    ...
    ?>
            ...
            <br>
            <form action="adminpagecontenthomecarouselledit.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="col-12">
                  ...
                  <button class="btn btn-warning" type="button" onclick="window.location.href='adminpagecontenthomecarousell.php'">Return</button>
                </div>
