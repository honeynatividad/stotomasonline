    ...
    <!-- End Page Title -->
      <script>
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                mysql_query("DELETE FROM tblfeedbackpic WHERE fldcode = '$vcodex'");
                ?>
                <script>
      ...
      <div class="row align-items-top">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
            <form action="farmfeedbackpicdelete.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
