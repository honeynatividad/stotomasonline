...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-journal-bookmark"></i>&nbsp;Insurance</h5> 
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='admininsuranceadd.php'">Add New Insurance Form</button>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='admininsuranceedit.php?vuid=<?php echo $row['fldcode']; ?>'">Edit</button>
                      
                        <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='admininsuranceview.php?vuid=<?php echo $row['fldcode']; ?>'">View Submitted Forms</button>
                      </td>
                  </tr>
