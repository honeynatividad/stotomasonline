...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-vinyl"></i>&nbsp;Seed Request</h5> 
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='farmseedreqadd.php'">Add New Seed Request</button>
            ...
            <hr/>
              ...
              <table class="table datatable">
                ...
                <tbody>
                     <?php 
				        $vcounter=1;
				        $result = mysql_query("SELECT * FROM tblseedrequested where fldrequestedby='$vcode' && fldstatus!='Retired' order by flddaterequested desc");
				        while($row = mysql_fetch_array($result))
				        {
                            ...
                            $vlotarea="";
                            $result1 = mysql_query("SELECT * FROM tbluser where fldcode='$vcode' && fldlocation='$vlocation'  order by fldindex");
				            while($row1 = mysql_fetch_array($result1))
				            {
                                $vlotarea=$row1['fldlotarea'];
                            }
                            $result1 = mysql_query("SELECT * FROM tblfarm where fldfarmercode='$vcode' && fldlocation='$vlocation'  order by fldindex");
				            while($row1 = mysql_fetch_array($result1))
				            {
                  ...
                  <tr>
                    ...
                    {
                     ?>   
                    <td><button disabled type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminadminedit.php?vuid=<?php echo $row['fldcode']; ?>'">Edit</button></td>
                    <?php
                    }
                    else
                    {
                    ?>
                    <td><button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='farmseedreqedit.php?vuid=<?php echo $row['fldcode']; ?>'">Edit</button></td>       
                    <?php
                    }
                    ?>
                  </tr>
