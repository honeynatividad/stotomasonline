...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Manage Images for Farm Inputs Distribution</h5> 
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminpagecontent.php">Page Content</a></li>
            <li class="breadcrumb-item">Manage Images for Farm Inputs Distribution</li>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminpagecontenthomefarminputsadd.php'">Add New Image for Farm Inputs Distribution</button>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a target="_blank" href="img/<?php echo $row['fldimage']; ?>"><img width="60" height="70" src="img/<?php echo $row['fldimage']; ?>" /></td>
                    <td><?php echo $row['fldstatus']; ?></td>
                    <td><button type="button" class="btn btn-danger btn-sm" onclick="window.location.href='adminpagecontenthomefarminputsedit.php?vuid=<?php echo $row['fldcode']; ?>'">Delete</button></td>
                  </tr>
