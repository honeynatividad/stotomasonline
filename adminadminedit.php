...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-people"></i>&nbsp;Users / System Administrators / Edit</h5>
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                $vcodex=$_POST['txtcode'];
								...
								{
								    mysql_query("UPDATE tbluser SET fldlastname = '$vlastnamex',fldfirstname = '$vfirstnamex',fldmiddlename = '$vmiddlenamex',fldusername = '$vusernamex',fldstatus = '$vstatusx',fldemail = '$vemailx' WHERE fldcode = '$vcodex'");										
										
								?>
                                <script>
								alert("Sysem Administrator Updated.");	
								</script>   
            ...
            <form action="adminadminedit.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
