...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Add New Image for Farm Inputs Distribution</h5>
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminpagecontent.php">Page Content</a></li>
            <li class="breadcrumb-item"><a href="adminpagecontenthomefarminputs.php">Manage Images for Farm Inputs Distribution</a></li>
                <li class="breadcrumb-item">Add New Image for Farm Inputs Distribution</li>
    ...
    $vctr=0;
        $result = mysql_query("SELECT * FROM tblpagefarminputs order by fldindex");
        while($row = mysql_fetch_array($result))
        {
            $vctr=$row['fldindex'];
        }
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $sql="INSERT INTO tblpagefarminputs (fldindex, fldcode, fldimage, fldstatus) 
	VALUES ('$vctr','$vcodex','$pic','Published')";
				    ...
				    ?>
                    <script>
				    alert("New Farm Inputs Distribution Image Saved.");	
				    </script>   
    ...
    ?>
            ...
            <br>
            <form action="adminpagecontenthomefarminputsadd.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Image</label>
                  <div class="col-sm-3">
                  <input type="file" id="photo" name="photo"  title="Upload New Image">
                    </div>
