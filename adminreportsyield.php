...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-files"></i>&nbsp;Dashboard / Reports / Yield</h5> 
      
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
            <li class="breadcrumb-item">Reports</li>
          <li class="breadcrumb-item">Yield</li>
        </ol>
      </nav>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <form name="formadd1" enctype="multipart/form-data" target="_blank" action="tcpdf/examples/storepyield.php" method="post" class="form-horizontal" id="block-validate">	
