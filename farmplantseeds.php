...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-sliders"></i>&nbsp;Planting Seeds</h5> 
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <br>
                <font color=blue>Distributed Seeds</font>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    if($row['fldstatus']=="Distributed" && $vdisstatus!="Seed Planted")        
                    {
                     ?>   
                    <td>
                        <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='farmplantseedsrec.php?vuid=<?php echo $row['fldcode']; ?>'">Record</button>
