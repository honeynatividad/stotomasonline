...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-people"></i>&nbsp;Users / System Administrators</h5> 
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminadminadd.php'">Add New System Adminstrators</button>
               <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminfarmers.php'">Farmers</button>
        <?php //echo "aaa".$vforexpire;  ?>     
            ...
            <hr/>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    <th scope="col">Adminstrator's Name</th>
                ...
                <tbody>
                     <?php 
				        $vcounter=1;
				        $result = mysql_query("SELECT * FROM tbluser where fldcode!='$vcode' && fldusertype!='Farmer' order by fldindex");
				        while($row = mysql_fetch_array($result))
				        {
				        ?>
                  <tr>
                    ...
                    <td><img width="30" height="30" src="assets/img/<?php echo $row['fldimage']; ?>" /></td>
                    <td><button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminadminedit.php?vuid=<?php echo $row['fldcode']; ?>'">Edit</button>
                     | 
				                <a href="adminadminDelete.php?vuid=<?php echo $row['fldcode'] ?>">
