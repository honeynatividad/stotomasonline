...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-journal-bookmark"></i>&nbsp;Insurance / View Submitted Forms</h5> 
      
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admininsurance.php">Insurance</a></li>
            <li class="breadcrumb-item">View Submitted Forms</li>
                ...
                <tbody>
                     <?php 
				        ...
				        while($row = mysql_fetch_array($result))
				        {
				            ...
				            {
                                $vfarmername=$row1['fldlastname'].", ".$row1['fldfirstname']." ".$row1['fldmiddlename'];  
