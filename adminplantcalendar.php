      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminplantcalendaradd.php'">Add New Item</button> 
            <hr/>
                ...
                <tbody>
                     <?php 
				        ...
				        ?>
                            ...
                            <td><button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminplantcalendaredit.php?vuid=<?php echo $row['fldcode']; ?>'">Edit</button></td>
                            </tr>
