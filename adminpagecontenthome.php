...
<!-- End Menu -->
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Manage Images for Announcements</h5> 
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <br>
                                    <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminhomeadd.php'">Add New Home Page Content</button>
                                    ...
                                    <table class="table datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Home Page Sub Title </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['fldhometitle']; ?></td>  
                                                <td><?php echo $row['fldhomesubtitle']; ?></td>
                                                <td><a target="_blank" href="img/<?php echo $row['fldbanner']; ?>"><img width="60" height="70" src="img/<?php echo $row['fldbanner']; ?>" /></td>
                                                <td><?php echo $row['created']; ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminhomeedit.php?vuid=<?php echo $row['fldindex']; ?>'">Edit</button>
