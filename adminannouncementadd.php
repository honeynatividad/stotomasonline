...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    ?>
            ...
            <form action="adminannouncementadd.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
