...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-chat-text"></i>&nbsp;Feedback / Add New Feedback</h5> 
    ...
    <?php
        ...
        $vctr=0;
        $result = mysql_query("SELECT * FROM tblfeedback order by fldindex");
        while($row = mysql_fetch_array($result))
        {
            $vctr=$row['fldindex'];
        }
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $vtitlex=$_POST['txttitle'];
                $vfeedbackx=$_POST['txtfeedback'];
                ...
                $vdatexx = $vdatex->format("Y-m-d");	
                    ...
                    $sql="INSERT INTO tblfeedback (fldindex, fldcode, fldtitle, fldfeedback, flddate, fldfarmercode, fldstatus) VALUES ('$vctr','$vcodex','$vtitlex','$vfeedbackx','$vdatexx','$vusercode','$vstatusx')";
                 ...
                 ?>
				    ...
				    alert("Feedback Saved.");	
    		          ...
    		          <meta  http-equiv="refresh" content=".000001;url=farmfeedback.php" />
            	       <?php   
            }
        }
    /////////////////////////////////////////////////////////
    ?>
            ...
            <form action="farmfeedbackadd.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  ...
                  <input type="text" class="form-control col-sm-2" placeholder="" id="validationCustom01" name="txttitle" value="<?php echo $vtitlex; ?>" required>  
                ...
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Feedback</label>
                  <div class="col-sm-8">
                
                      
                      
                  <textarea id="validationCustom01" rows="4" class="form-control col-sm-2" name="txtfeedback"><?php echo $vquestionx; ?></textarea>
                ...
                <div class="row mb-3">
                  <label for="inputState" class="form-label col-sm-2 col-form-label">Post Feedback?</label>
                 <div class="col-sm-3">
                ...
                <div class="col-12">
                  ...
                  <button class="btn btn-warning" type="button" onclick="window.location.href='farmfeedback.php'">Return</button>
                </div>
