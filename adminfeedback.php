            ...
            <hr/>
              ...
              <table class="table datatable">
                ...
                <tbody>
                     <?php 
				        $vcounter=1;
				        $result = mysql_query("SELECT * FROM tblfeedback where fldstatus='Yes' order by fldindex");
				        while($row = mysql_fetch_array($result))
				        {
                            $vfarmercode=$row['fldfarmercode'];
                            $result1 = mysql_query("SELECT * FROM tbluser where fldcode='$vfarmercode' order by fldindex");
				            while($row1 = mysql_fetch_array($result1))
				            {
                                $vfarmer=$row1['fldlastname'].", ".$row1['fldfirstname']." ".$row1['fldmiddlename'];  
                                $vfemail=$row1['fldemail'];
                            }
                    ?>
                                <tr>
                                ...
                                <td>
                                <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminfeedbackpic.php?vuid=<?php echo $row['fldcode']; ?>&vuid1=<?php echo $vfemail; ?>'">View Picture</button>
                                </td>
                                <td>
                                <button type="button" class="btn btn-success btn-sm" onclick="window.location.href='adminfeedbackdelete.php?vuid=<?php echo $row['fldcode']; ?>&vuid1=<?php echo $vfemail; ?>'">View Feedback</button>
                                </td>
