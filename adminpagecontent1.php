...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content</h5> 
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminannouncementadd.php'">Add New Announcement</button>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a target="_blank" href="../stotomaswebsite/img/<?php echo $row['fldannouncement']; ?>"><img width="60" height="70" src="../stotomaswebsite/img/<?php echo $row['fldannouncement']; ?>" /></td>
                    <td><?php echo $row['fldstatus']; ?></td>
                    <td><button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminannouncementedit.php?vuid=<?php echo $row['fldcode']; ?>'">Edit</button></td>
                  </tr>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminvideoadd.php'">Add New Video</button>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <video width="200" height="150" controls>
  					<source src="../stotomaswebsite/video/<?php echo $row['fldvideo']; ?>" type="video/mp4">
					
		          </video>  
                    </td>
                    <td><?php echo $row['fldstatus']; ?></td>
                    <td><button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminvideoedit.php?vuid=<?php echo $row['fldcode']; ?>'">Edit</button></td>
                  </tr>
