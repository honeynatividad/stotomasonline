...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-sliders"></i>&nbsp;Planting Seeds / Fertilizer</h5> 
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <hr/>
                <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='farmplantseedsfertadd.php?vuid=<?php echo $vdistributioncodex; ?>&vuid1=<?php echo $vcropx; ?>&vuid2=<?php echo $vplantedcode; ?>&vuid3=<?php echo $vdateplantedx; ?>'">Record Fertilizer Application</button>
            ...
            <hr/>
              ...
              <table class="table datatable">
                ...
                <tbody>
                     <?php 
				        $vcounter=1;
				        $result = mysql_query("SELECT * FROM tblplantfert where fldplantedcode='$vplantedcode' order by fldindex");
				        while($row = mysql_fetch_array($result))
				        {
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['flddateapplied']; ?></td>
                    
                    
                    <td><button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='farmplantseedsfertedit.php?vuid=<?php echo $vdistributioncodex; ?>&vuid1=<?php echo $vcropx; ?>&vuid2=<?php echo $vplantedcode; ?>&vuid3=<?php echo $vdateplantedx; ?>&vuid4=<?php echo $row['fldcode']; ?>'">Edit Record</button></td>       
