...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-journal-bookmark"></i>&nbsp;Insurance / Add New Insurance Form</h5>
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
				...
				if($pic=="")
				{
				    ...
				    $sql="INSERT INTO tblinsurance (fldindex, fldcode, fldinsurance, fldstatus) VALUES ('$vctr','$vcodex','$pic','$vstatusx')";
				    ...
				    ?>
                    <script>
				    alert("New Insurance Form Saved.");	
				    </script>   
    ...
    ?>
            ...
            <form action="admininsuranceadd.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
