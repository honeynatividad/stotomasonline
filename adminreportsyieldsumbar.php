      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <form name="formadd1" enctype="multipart/form-data"   action="adminreportsyieldsumbar1.php" method="post" class="form-horizontal" id="block-validate">	
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                ...
                <div class="row mb-3">
                  <label for="inputState" class="form-label col-sm-2 col-form-label">Barangay</label>
                 <div class="col-sm-3">
