...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-flower1"></i>&nbsp;Crops / Seed Distribution / Picture-Harvest</h5>
          ...
          <div class="card">
            ...
            <table class="table">
              ...
              <!-- End Table with stripped rows -->
                ...
                <button class="btn btn-warning btn-sm" type="button" onclick="window.location.href='adminseeddistributionall.php?vuid=<?php echo $vcropcode; ?>'">Return</button>
