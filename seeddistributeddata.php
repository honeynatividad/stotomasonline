...
$result = mysql_query("SELECT fldrequestedseed,SUM(fldrequestedqty) as fldrequestedqty FROM tblseedrequested where flddaterequested <= '$vdatetoday' && fldstatus='Distributed' GROUP BY fldrequestedseed order by fldrequestedseed");
