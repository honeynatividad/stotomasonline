...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-shop"></i>&nbsp;Barangays / Edit</h5>
    ...
    $vbarangayx=$_REQUEST['vuid'];
								
        $result = mysql_query("SELECT * FROM tblbarangay where fldbarangay='$vbarangayx'");
        while($row = mysql_fetch_array($result))
        {
    ...
    ?>
            ...
            <form action="adminbarangaysedit.php" name="frm" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                    ...
                    <input type="hidden" name="txtbarangayold" id="txtbarangayold" value="<?php echo $vbarangayoldx; ?>">
                  <div>
                  </div>
