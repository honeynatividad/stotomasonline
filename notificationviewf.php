  ...
  <main id="main" class="main">
      ...
      <div class="row align-items-top">
        <div class="col-lg-6">
          ...
          <!-- Default Card -->
        <?php
            $result = mysql_query("SELECT * FROM tblnotificationf where fldsource='Administrator' order by flddate desc");
            while($row = mysql_fetch_array($result))
            {
                $vtitle=$row['fldtitle'];
          ...
          <div class="card">
            ...
            mysql_query("UPDATE tblnotificationf  SET fldstatus = 'Viewed' WHERE fldsource = 'Administrator'")	
            ?>
