            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                     <?php 
				        $vcounter=1;
                        $result = mysql_query("SELECT * FROM tblseedrequested where fldrequestedseed='$vcropcode' && fldstatus!='Retired' order by fldindex");
				        while($row = mysql_fetch_array($result))
				        {
                  ...
                  <tr>
                    ...
                    {
                    ?>   
                    <td><button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminseeddistribution1.php?vuid=<?php echo $row1['fldcode']; ?>&vuid1=<?php echo $vcropcode; ?>&vuid2=<?php echo $row['fldcode']; ?>'">Distribute</button></td>
                    ...
                    <td>
                      <?php
                          ...
                          {
                        ?>
                        <button type="button" class="btn btn-danger btn-sm" onclick="window.location.href='adminretire.php?vuid=<?php echo $row1['fldcode']; ?>&vuid1=<?php echo $vcropcode; ?>&vuid2=<?php echo $row['fldcode']; ?>'">Retire</button>
                        <?php
                          }
                        else
                        {
                         ?>
                        <button disabled type="button" class="btn btn-danger btn-sm" onclick="window.location.href='adminretire.php?vuid=<?php echo $row1['fldcode']; ?>&vuid1=<?php echo $vcropcode; ?>&vuid2=<?php echo $row['fldcode']; ?>'">Retire</button>
                        <?php
