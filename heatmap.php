            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#team">Mapping</a></li>
...
$result = mysql_query("SELECT * FROM tblseedrequested where  fldstatus!='Retired' order by fldindex");
				        while($row = mysql_fetch_array($result))
				        {
                            ...
                            {
                                $vampreq1=$vampreq1+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Agustin" && $vcrops=="Eggplant")
                            {
                                $vampreq101=$vampreq101+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Agustin" && $vcrops=="Squash")
                            {
                                $vampreq201=$vampreq201+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Agustin" && $vcrops=="Cucumber")
                            {
                                $vampreq301=$vampreq301+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Agustin" && $vcrops=="Okra")
                            {
                                $vampreq401=$vampreq401+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Agustin" && $vcrops=="Pole Sitao")
                            {
                                $vampreq501=$vampreq501+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Agustin" && $vcrops=="Tomato")
                            {
                                $vampreq601=$vampreq601+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Agustin" && $vcrops=="Patola")
                            {
                                $vampreq701=$vampreq701+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq2=$vampreq2+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Antonio" && $vcrops=="Eggplant")
                            {
                                $vampreq102=$vampreq102+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Antonio" && $vcrops=="Squash")
                            {
                                $vampreq202=$vampreq202+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Antonio" && $vcrops=="Cucumber")
                            {
                                $vampreq302=$vampreq302+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Antonio" && $vcrops=="Okra")
                            {
                                $vampreq402=$vampreq402+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Antonio" && $vcrops=="Pole Sitao")
                            {
                                $vampreq502=$vampreq502+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Antonio" && $vcrops=="Tomato")
                            {
                                $vampreq602=$vampreq602+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Antonio" && $vcrops=="Patola")
                            {
                                $vampreq702=$vampreq702+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq3=$vampreq3+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Rafael" && $vcrops=="Eggplant")
                            {
                                $vampreq103=$vampreq103+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Rafael" && $vcrops=="Squash")
                            {
                                $vampreq203=$vampreq203+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Rafael" && $vcrops=="Cucumber")
                            {
                                $vampreq303=$vampreq303+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Rafael" && $vcrops=="Okra")
                            {
                                $vampreq403=$vampreq403+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Rafael" && $vcrops=="Pole Sitao")
                            {
                                $vampreq503=$vampreq503+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Rafael" && $vcrops=="Tomato")
                            {
                                $vampreq603=$vampreq603+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Rafael" && $vcrops=="Patola")
                            {
                                $vampreq703=$vampreq703+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq4=$vampreq4+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santiago" && $vcrops=="Eggplant")
                            {
                                $vampreq104=$vampreq104+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santiago" && $vcrops=="Squash")
                            {
                                $vampreq204=$vampreq204+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santiago" && $vcrops=="Cucumber")
                            {
                                $vampreq304=$vampreq304+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santiago" && $vcrops=="Okra")
                            {
                                $vampreq404=$vampreq404+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santiago" && $vcrops=="Pole Sitao")
                            {
                                $vampreq504=$vampreq504+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santiago" && $vcrops=="Tomato")
                            {
                                $vampreq604=$vampreq604+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santiago" && $vcrops=="Patola")
                            {
                                $vampreq704=$vampreq704+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq5=$vampreq5+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Bartolome" && $vcrops=="Eggplant")
                            {
                                $vampreq105=$vampreq105+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Bartolome" && $vcrops=="Squash")
                            {
                                $vampreq205=$vampreq205+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Bartolome" && $vcrops=="Cucumber")
                            {
                                $vampreq305=$vampreq305+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Bartolome" && $vcrops=="Okra")
                            {
                                $vampreq405=$vampreq405+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Bartolome" && $vcrops=="Pole Sitao")
                            {
                                $vampreq505=$vampreq505+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Bartolome" && $vcrops=="Tomato")
                            {
                                $vampreq605=$vampreq605+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Bartolome" && $vcrops=="Patola")
                            {
                                $vampreq705=$vampreq705+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq6=$vampreq6+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Miguel" && $vcrops=="Eggplant")
                            {
                                $vampreq106=$vampreq106+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Miguel" && $vcrops=="Squash")
                            {
                                $vampreq206=$vampreq206+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Miguel" && $vcrops=="Cucumber")
                            {
                                $vampreq306=$vampreq306+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Miguel" && $vcrops=="Okra")
                            {
                                $vampreq406=$vampreq406+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Miguel" && $vcrops=="Pole Sitao")
                            {
                                $vampreq506=$vampreq506+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Miguel" && $vcrops=="Tomato")
                            {
                                $vampreq606=$vampreq606+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Miguel" && $vcrops=="Patola")
                            {
                                $vampreq706=$vampreq706+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq7=$vampreq7+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Felix" && $vcrops=="Eggplant")
                            {
                                $vampreq107=$vampreq107+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Felix" && $vcrops=="Squash")
                            {
                                $vampreq207=$vampreq207+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Felix" && $vcrops=="Cucumber")
                            {
                                $vampreq307=$vampreq307+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Felix" && $vcrops=="Okra")
                            {
                                $vampreq407=$vampreq407+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Felix" && $vcrops=="Pole Sitao")
                            {
                                $vampreq507=$vampreq507+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Felix" && $vcrops=="Tomato")
                            {
                                $vampreq607=$vampreq607+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Felix" && $vcrops=="Patola")
                            {
                                $vampreq707=$vampreq707+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq8=$vampreq8+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Fernando" && $vcrops=="Eggplant")
                            {
                                $vampreq108=$vampreq108+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Fernando" && $vcrops=="Squash")
                            {
                                $vampreq208=$vampreq208+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Fernando" && $vcrops=="Cucumber")
                            {
                                $vampreq308=$vampreq308+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Fernando" && $vcrops=="Okra")
                            {
                                $vampreq408=$vampreq408+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Fernando" && $vcrops=="Pole Sitao")
                            {
                                $vampreq508=$vampreq508+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Fernando" && $vcrops=="Tomato")
                            {
                                $vampreq608=$vampreq608+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Fernando" && $vcrops=="Patola")
                            {
                                $vampreq708=$vampreq708+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq9=$vampreq9+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Francisco" && $vcrops=="Eggplant")
                            {
                                $vampreq109=$vampreq109+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Francisco" && $vcrops=="Squash")
                            {
                                $vampreq209=$vampreq209+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Francisco" && $vcrops=="Cucumber")
                            {
                                $vampreq309=$vampreq309+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Francisco" && $vcrops=="Okra")
                            {
                                $vampreq409=$vampreq409+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Francisco" && $vcrops=="Pole Sitao")
                            {
                                $vampreq509=$vampreq509+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Francisco" && $vcrops=="Tomato")
                            {
                                $vampreq609=$vampreq609+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Francisco" && $vcrops=="Patola")
                            {
                                $vampreq709=$vampreq709+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq10=$vampreq10+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Norte" && $vcrops=="Eggplant")
                            {
                                $vampreq110=$vampreq110+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Norte" && $vcrops=="Squash")
                            {
                                $vampreq210=$vampreq210+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Norte" && $vcrops=="Cucumber")
                            {
                                $vampreq310=$vampreq310+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Norte" && $vcrops=="Okra")
                            {
                                $vampreq410=$vampreq410+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Norte" && $vcrops=="Pole Sitao")
                            {
                                $vampreq510=$vampreq510+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Norte" && $vcrops=="Tomato")
                            {
                                $vampreq610=$vampreq610+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Norte" && $vcrops=="Patola")
                            {
                                $vampreq710=$vampreq710+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq11=$vampreq11+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Sur" && $vcrops=="Eggplant")
                            {
                                $vampreq111=$vampreq111+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Sur" && $vcrops=="Squash")
                            {
                                $vampreq211=$vampreq211+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Sur" && $vcrops=="Cucumber")
                            {
                                $vampreq311=$vampreq311+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Sur" && $vcrops=="Okra")
                            {
                                $vampreq411=$vampreq411+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Sur" && $vcrops=="Pole Sitao")
                            {
                                $vampreq511=$vampreq511+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Sur" && $vcrops=="Tomato")
                            {
                                $vampreq611=$vampreq611+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Isidro Sur" && $vcrops=="Patola")
                            {
                                $vampreq711=$vampreq711+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq12=$vampreq12+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Joaquin" && $vcrops=="Eggplant")
                            {
                                $vampreq112=$vampreq112+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Joaquin" && $vcrops=="Squash")
                            {
                                $vampreq212=$vampreq212+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Joaquin" && $vcrops=="Cucumber")
                            {
                                $vampreq312=$vampreq312+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Joaquin" && $vcrops=="Okra")
                            {
                                $vampreq412=$vampreq412+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Joaquin" && $vcrops=="Pole Sitao")
                            {
                                $vampreq512=$vampreq512+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Joaquin" && $vcrops=="Tomato")
                            {
                                $vampreq612=$vampreq612+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Joaquin" && $vcrops=="Patola")
                            {
                                $vampreq712=$vampreq712+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq13=$vampreq13+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Jose" && $vcrops=="Eggplant")
                            {
                                $vampreq113=$vampreq113+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Jose" && $vcrops=="Squash")
                            {
                                $vampreq213=$vampreq213+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Jose" && $vcrops=="Cucumber")
                            {
                                $vampreq313=$vampreq313+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Jose" && $vcrops=="Okra")
                            {
                                $vampreq413=$vampreq413+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Jose" && $vcrops=="Pole Sitao")
                            {
                                $vampreq513=$vampreq513+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Jose" && $vcrops=="Tomato")
                            {
                                $vampreq613=$vampreq613+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Jose" && $vcrops=="Patola")
                            {
                                $vampreq713=$vampreq713+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq14=$vampreq14+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Juan" && $vcrops=="Eggplant")
                            {
                                $vampreq114=$vampreq114+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Juan" && $vcrops=="Squash")
                            {
                                $vampreq214=$vampreq214+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Juan" && $vcrops=="Cucumber")
                            {
                                $vampreq314=$vampreq314+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Juan" && $vcrops=="Okra")
                            {
                                $vampreq414=$vampreq414+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Juan" && $vcrops=="Pole Sitao")
                            {
                                $vampreq514=$vampreq514+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Juan" && $vcrops=="Tomato")
                            {
                                $vampreq614=$vampreq614+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Juan" && $vcrops=="Patola")
                            {
                                $vampreq714=$vampreq714+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq15=$vampreq15+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Luis" && $vcrops=="Eggplant")
                            {
                                $vampreq115=$vampreq115+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Luis" && $vcrops=="Squash")
                            {
                                $vampreq215=$vampreq215+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Luis" && $vcrops=="Cucumber")
                            {
                                $vampreq315=$vampreq315+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Luis" && $vcrops=="Okra")
                            {
                                $vampreq415=$vampreq415+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Luis" && $vcrops=="Pole Sitao")
                            {
                                $vampreq515=$vampreq515+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Luis" && $vcrops=="Tomato")
                            {
                                $vampreq615=$vampreq615+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Luis" && $vcrops=="Patola")
                            {
                                $vampreq715=$vampreq715+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq16=$vampreq16+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pablo" && $vcrops=="Eggplant")
                            {
                                $vampreq116=$vampreq116+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pablo" && $vcrops=="Squash")
                            {
                                $vampreq216=$vampreq216+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pablo" && $vcrops=="Cucumber")
                            {
                                $vampreq316=$vampreq316+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pablo" && $vcrops=="Okra")
                            {
                                $vampreq416=$vampreq416+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pablo" && $vcrops=="Pole Sitao")
                            {
                                $vampreq516=$vampreq516+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pablo" && $vcrops=="Tomato")
                            {
                                $vampreq616=$vampreq616+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pablo" && $vcrops=="Patola")
                            {
                                $vampreq716=$vampreq716+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq17=$vampreq17+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pedro" && $vcrops=="Eggplant")
                            {
                                $vampreq117=$vampreq117+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pedro" && $vcrops=="Squash")
                            {
                                $vampreq217=$vampreq217+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pedro" && $vcrops=="Cucumber")
                            {
                                $vampreq317=$vampreq317+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pedro" && $vcrops=="Okra")
                            {
                                $vampreq417=$vampreq417+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pedro" && $vcrops=="Pole Sitao")
                            {
                                $vampreq517=$vampreq517+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pedro" && $vcrops=="Tomato")
                            {
                                $vampreq617=$vampreq617+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="San Pedro" && $vcrops=="Patola")
                            {
                                $vampreq717=$vampreq717+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq18=$vampreq18+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Teresita" && $vcrops=="Eggplant")
                            {
                                $vampreq118=$vampreq118+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Teresita" && $vcrops=="Squash")
                            {
                                $vampreq218=$vampreq218+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Teresita" && $vcrops=="Cucumber")
                            {
                                $vampreq318=$vampreq318+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Teresita" && $vcrops=="Okra")
                            {
                                $vampreq418=$vampreq418+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Teresita" && $vcrops=="Pole Sitao")
                            {
                                $vampreq518=$vampreq518+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Teresita" && $vcrops=="Tomato")
                            {
                                $vampreq618=$vampreq618+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Teresita" && $vcrops=="Patola")
                            {
                                $vampreq718=$vampreq718+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq19=$vampreq19+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Maria" && $vcrops=="Eggplant")
                            {
                                $vampreq119=$vampreq119+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Maria" && $vcrops=="Squash")
                            {
                                $vampreq219=$vampreq219+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Maria" && $vcrops=="Cucumber")
                            {
                                $vampreq319=$vampreq319+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Maria" && $vcrops=="Okra")
                            {
                                $vampreq419=$vampreq419+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Maria" && $vcrops=="Pole Sitao")
                            {
                                $vampreq519=$vampreq519+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Maria" && $vcrops=="Tomato")
                            {
                                $vampreq619=$vampreq619+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Maria" && $vcrops=="Patola")
                            {
                                $vampreq719=$vampreq719+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq20=$vampreq20+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Elena" && $vcrops=="Eggplant")
                            {
                                $vampreq120=$vampreq120+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Elena" && $vcrops=="Squash")
                            {
                                $vampreq220=$vampreq220+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Elena" && $vcrops=="Cucumber")
                            {
                                $vampreq320=$vampreq320+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Elena" && $vcrops=="Okra")
                            {
                                $vampreq420=$vampreq420+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Elena" && $vcrops=="Pole Sitao")
                            {
                                $vampreq520=$vampreq520+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Elena" && $vcrops=="Tomato")
                            {
                                $vampreq620=$vampreq620+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Elena" && $vcrops=="Patola")
                            {
                                $vampreq720=$vampreq720+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq21=$vampreq21+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Clara" && $vcrops=="Eggplant")
                            {
                                $vampreq121=$vampreq121+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Clara" && $vcrops=="Squash")
                            {
                                $vampreq221=$vampreq221+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Clara" && $vcrops=="Cucumber")
                            {
                                $vampreq321=$vampreq321+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Clara" && $vcrops=="Okra")
                            {
                                $vampreq421=$vampreq421+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Clara" && $vcrops=="Pole Sitao")
                            {
                                $vampreq521=$vampreq521+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Clara" && $vcrops=="Tomato")
                            {
                                $vampreq621=$vampreq621+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Clara" && $vcrops=="Patola")
                            {
                                $vampreq721=$vampreq721+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq22=$vampreq22+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Anastacia" && $vcrops=="Eggplant")
                            {
                                $vampreq122=$vampreq122+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Anastacia" && $vcrops=="Squash")
                            {
                                $vampreq222=$vampreq222+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Anastacia" && $vcrops=="Cucumber")
                            {
                                $vampreq322=$vampreq322+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Anastacia" && $vcrops=="Okra")
                            {
                                $vampreq422=$vampreq422+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Anastacia" && $vcrops=="Pole Sitao")
                            {
                                $vampreq522=$vampreq522+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Anastacia" && $vcrops=="Tomato")
                            {
                                $vampreq622=$vampreq622+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Anastacia" && $vcrops=="Patola")
                            {
                                $vampreq722=$vampreq722+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq23=$vampreq23+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Ana" && $vcrops=="Eggplant")
                            {
                                $vampreq123=$vampreq123+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Ana" && $vcrops=="Squash")
                            {
                                $vampreq223=$vampreq223+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Ana" && $vcrops=="Cucumber")
                            {
                                $vampreq323=$vampreq323+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Ana" && $vcrops=="Okra")
                            {
                                $vampreq423=$vampreq423+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Ana" && $vcrops=="Pole Sitao")
                            {
                                $vampreq523=$vampreq523+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Ana" && $vcrops=="Tomato")
                            {
                                $vampreq623=$vampreq623+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Ana" && $vcrops=="Patola")
                            {
                                $vampreq723=$vampreq723+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq24=$vampreq24+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Cruz" && $vcrops=="Eggplant")
                            {
                                $vampreq124=$vampreq124+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Cruz" && $vcrops=="Squash")
                            {
                                $vampreq224=$vampreq224+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Cruz" && $vcrops=="Cucumber")
                            {
                                $vampreq324=$vampreq324+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Cruz" && $vcrops=="Okra")
                            {
                                $vampreq424=$vampreq424+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Cruz" && $vcrops=="Pole Sitao")
                            {
                                $vampreq524=$vampreq524+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Cruz" && $vcrops=="Tomato")
                            {
                                $vampreq624=$vampreq624+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Cruz" && $vcrops=="Patola")
                            {
                                $vampreq724=$vampreq724+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                            ...
                            {
                                $vampreq25=$vampreq25+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Vicente" && $vcrops=="Eggplant")
                            {
                                $vampreq125=$vampreq125+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Vicente" && $vcrops=="Squash")
                            {
                                $vampreq225=$vampreq225+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Vicente" && $vcrops=="Cucumber")
                            {
                                $vampreq325=$vampreq325+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Vicente" && $vcrops=="Okra")
                            {
                                $vampreq425=$vampreq425+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Vicente" && $vcrops=="Pole Sitao")
                            {
                                $vampreq525=$vampreq525+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Vicente" && $vcrops=="Tomato")
                            {
                                $vampreq625=$vampreq625+$row['fldrequestedqty'];
                            }
                            if($vbarangay=="Santa Vicente" && $vcrops=="Patola")
                            {
                                $vampreq725=$vampreq725+$row['fldrequestedqty'];
                            }
                            /////////////////////////////////
                        }
...
<script>
  ...
  // set the chart title
  chart.title("Seed Requests Per Barangay");
...
// create categories
  ...
  chart.draw();
    ...
    <div align=right>
    <button class="btn btn-warning" type="button" onclick="window.location.href='adminheatmapyield.php'">Yields</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
