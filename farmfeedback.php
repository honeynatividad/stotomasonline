...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-chat-text"></i>&nbsp;Feedback</h5> 
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='farmfeedbackadd.php'">Add New Feedback</button>
            ...
            <hr/>
              ...
              <table class="table datatable">
                ...
                <tbody>
                     <?php 
				        $vcounter=1;
				        $result = mysql_query("SELECT * FROM tblfeedback where fldfarmercode='$vcode' && fldstatus!='Deleted' order by fldindex");
				        while($row = mysql_fetch_array($result))
				        {
                    ...
                    ?>
                                ...
                                <td><?php echo $row['fldtitle']; ?></td>
                                <td><?php echo $row['fldfeedback']; ?></td>
                                <td><?php echo $row['flddate']; ?></td>
                                <td><?php echo $row['fldstatus']; ?></td>
                                
                                <td>
                                <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='farmfeedbackpic.php?vuid=<?php echo $row['fldcode']; ?>'">Picture</button>
                                </td>    
                                <td>
                                <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='farmfeedbackedit.php?vuid=<?php echo $row['fldcode']; ?>'">Edit</button>
                                </td>
                                
                                <td>
                                <button type="button" class="btn btn-danger btn-sm" onclick="window.location.href='farmfeedbackdelete.php?vuid=<?php echo $row['fldcode']; ?>'">Delete</button>
                                </td>
