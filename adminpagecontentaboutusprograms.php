...
<body>
  ...
  <!-- ======= Sidebar ======= -->
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h5><i class="bi bi-aspect-ratio"></i>&nbsp;Page Content / Update Program Chart</h5>
        
            <nav>
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="adminpagecontent.php">Page Content</a></li>
                    <li class="breadcrumb-item">Update Program Chart</li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        $vctr=0;
                                        $result = mysql_query("SELECT * FROM tblaboutus WHERE aboutus='Program Chart' ");
                                        $count = mysql_num_rows($result);
                                        while($row = mysql_fetch_array($result)){
                                            $aboutusDesc=$row['aboutusDesc'];
                                        }
                                        ...
                                        if($vtest==0){
                                            if($vtestx==1){
                                                ...
                                                if($count!=0) {
                                                    $sql="UPDATE tblaboutus SET aboutusDesc='$target' WHERE aboutus='Program Chart'";
                                                } else {
                                                    $sql="INSERT INTO tblaboutus (aboutus, aboutusDesc) VALUES ('Program Chart', '$target')";
                                                }
                                    ...
                                    <br>
                                    <form action="adminpagecontentaboutusprograms.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
                                    <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                                        ...
                                        <div class="row mb-3">
                                            <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Program Chart</label>
                                            <div class="col-sm-3">
                                                <input type="file" id="photo" name="photo" accept="image/png, image/gif, image/jpeg"  title="Upload program chart">
                                            </div>
