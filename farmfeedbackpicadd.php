  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <!-- End Logo -->
     ...
     <div class="pagetitle" align=left>
          <font color="blue"><?php echo $vtitlex; ?></font>
      ...
      <script>
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $vctr=0;
				$result = mysql_query("SELECT * FROM tblfeedbackpic order by fldindex");
				while($row = mysql_fetch_array($result))
				{
					$vctr=$row['fldindex'];
				}
                ...
                $vfeedbackcodex=$_POST['txtfeedbackcode'];
                ...
                $sql="INSERT INTO tblfeedbackpic (fldindex, fldcode, fldfeedbackcode, fldpicture, flddescription) 
	VALUES ('$vctr','$vcodex','$vfeedbackcodex','$pic','$vdescriptionx')";
      ...
      <div class="row align-items-top">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
            <form action="farmfeedbackpicadd.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
                <input type="hidden" name="txt1" id="txt1">
                    <input type="hidden" name="txtpost" id="txtpost">
                    <input type="hidden" name="txtfeedbackcode" id="txtfeedbackcode" value="<?php echo $vfeedbackcodex; ?>">
