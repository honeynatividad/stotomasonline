...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link " href="farminsurance.php">
...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-journal-bookmark"></i>&nbsp;Insurance / Upload Accomplished Form</h5> 
      
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="farminsurance.php">Insurance</a></li>
            <li class="breadcrumb-item">Upload Accomplished Insurance Form</li>
    ...
    <?php
    $vinsurancecodex=$_REQUEST['vuid'];
    $vctr=0;
        $result = mysql_query("SELECT * FROM tblinsuranceaccomplish order by fldindex");
        while($row = mysql_fetch_array($result))
        {
            $vctr=$row['fldindex'];
        }
        ...
        if($vtest==0)
        {
            if($vtestx==1)
            {
                ...
                $vinsurancecodex=$_POST['txtinsurancecode'];
                
                $vselectdate=date();
                $vdatex = new DateTime($vselectdate);
                $vdateax = $vdatex->format("Y-m-d");	
				...
				if($pic=="")
				{
				    ...
				    $sql="INSERT INTO tblinsuranceaccomplish (fldindex, fldcode, fldinsurancecode, fldinsurance, fldfarmercode, flddate, fldstatus) VALUES ('$vctr','$vcodex','$vinsurancecodex','$pic','$vfarmercode','$vdateax','For Verification')";
                    ...
                    $vtitlex="Accomplished Insurance Form Submitted";
                    $vsubtitlex=$vuser." has submitted .";
                    $vnotificationx="Mr. ".$vuser." has submitted an accomplished insurance form last ".$vdateax;
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                        ...
                        ////////////////////////////////////email
                                        $to      = $vemailx;
                                        $subject = 'Accomplished Insurance Forms';
                                        $message = 'Dear '.$vfirstnamex."\r\n"."\r\n".$vuser.'has submitted the accomplished insurance form.'."\r\n"."\r\n".'Thank you.';
				    ...
				    ?>
                    <script>
				    alert("Insurance Form Uploaded.");	
				    </script>   
    		          <meta  http-equiv="refresh" content=".000001;url=farminsuranceaccomplish.php?vuid=<?php echo $vinsurancecodex; ?>" />
            	       <?php   
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <br>
             <form action="farminsuranceaccomplish.php" name="frm" enctype="multipart/form-data" class="row g-3 needs-validation" id="block-validate" method="post" novalidate>
             ...
             <!--  <form class="row g-3 needs-validation" method="post" name="frm" id="block-validate" action="adminadminadd.php" enctype="multipart/form-data"  novalidate>-->
                    ...
                    <input type="hidden" name="txtinsurancecode" id="txtinsurancecode" value="<?php echo $vinsurancecodex; ?>">
                  <d
                  </div>
                ...
                <div class="row mb-3">
                  <label for="validationCustom01" class="form-label col-sm-2 col-form-label">Insurance Form</label>
                  <div  data-provides="fileupload" class="col-sm-3">
                ...
                <div class="col-12">
                  ...
                  <button class="btn btn-warning" type="button" onclick="window.location.href='farminsurance.php'">Return</button>
                </div>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Insurance Form</th>
                ...
                <tbody>
                     <?php 
				        $vcounter=1;
				        $result = mysql_query("SELECT * FROM tblinsuranceaccomplish where fldfarmercode='$vfarmercode' order by fldindex");
				        while($row = mysql_fetch_array($result))
				        {
				        ?>
                  <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-danger btn-sm" onclick="window.location.href='farminsurancedelete.php?vuid=<?php echo $row['fldcode']; ?>&vuid1=<?php echo $vinsurancecodex; ?>'">Delete</button>
