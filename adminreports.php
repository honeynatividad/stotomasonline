...
<!-- End Menu -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h5><i class="bi bi-files"></i>&nbsp;Reports</h5> 
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminreportsrequest.php'">Seed Request</button>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminreportsdistribution.php'">Seed Distribution</button>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminreportsyield.php'">Crop Yields</button>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminreportsbarangay.php'">For Intervention</button><br><br>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminreportsrequestsum.php'">Summary Of Seed Request</button>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminreportsdistributionsum.php'">Summary Of Seed Distribution</button>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminreportsyieldsum.php'">Summary Of Crop Yields</button>
              <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='adminreportsyieldsumbar.php'">Summary Of Crop Yields Per Barangay</button>
            <hr/>
