                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='farminsuranceaccomplish.php?vuid=<?php echo $row['fldcode']; ?>'">Upload Accomplished Form</button>
                      </td>
                  </tr>
